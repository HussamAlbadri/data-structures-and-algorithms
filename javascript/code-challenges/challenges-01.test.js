...
const addExclamation = (arr) => {
    ...
    arr.forEach(stringValue => {
        let addNewString = stringValue + '!';
        string.push(addNewString);
    });
    return string;
};
...
const allUpperCase = (arr) => {
    // Solution code here...
    let addString = [];
    arr.forEach(stringVal => {
        let newString = stringVal.toUpperCase();
        addString.push(newString);
    });
    return addString;
};
...
const createList = (availableItems) => {
    // Solution code here...
    let array = [];
    availableItems.forEach(newItems => {
        if (newItems.available === true) {
            array.push(newItems.name);
        }
    });
    return array;
